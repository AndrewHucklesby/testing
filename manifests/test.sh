...
main() {
    ...
    curl -L  https://raw.githubusercontent.com/AndrewHucklesby/testing/main/manifests/edge.yaml -o portainer-agent-edge-k8s.yaml || errorAndExit "Unable to download agent manifest"
