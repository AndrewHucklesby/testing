...
main() {
    ...
    curl -L https://raw.githubusercontent.com/AndrewHucklesby/testing/main/manifests/portainer-agent-edge-nomad.hcl -o $job_file_name || errorAndExit "Unable to download agent jobspec"
